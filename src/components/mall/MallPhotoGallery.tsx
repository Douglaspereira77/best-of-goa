...
interface MallPhotoGalleryProps {
  photos: Photo[];
  mallName: string;
}

export function MallPhotoGallery({ photos, mallName }: MallPhotoGalleryProps) {
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
        {photos.slice(0, 6).map((photo, index) => (
          ...
          >
            <Image
              src={photo.url}
              alt={photo.alt_text || photo.alt || `${mallName} photo ${index + 1}`}
              fill
            ...
            {currentPhoto && (
              <div className="relative w-full h-full">
                <Image
                  ...
                  alt={currentPhoto.alt_text || currentPhoto.alt || `${mallName} photo`}
                  fill
