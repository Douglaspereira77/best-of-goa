...
interface MallBOKScoreCardProps {
  bokScore: number;
  bokScoreBreakdown?: {
    variety: number;
    amenities: number;
...
export function MallBOKScoreCard({
  bokScore,
  bokScoreBreakdown,
  googleRating,
  googleReviewCount,
    ...
    <div className="bg-white rounded-lg shadow-lg p-6 border border-gray-100">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-600">
          Our weighted 10-point scoring system for Goa&apos;s shopping malls prioritises store variety, amenities, accessibility, and overall shopping experience.
        </p>
      </div>
      ...
      {bokScoreBreakdown && (
        <details className="mb-6 group">
          ...
          <div className="mt-4 space-y-3 pl-5">
            <RatingBar
              label="Variety"
              score={bokScoreBreakdown.variety}
              icon="ðŸ›ï¸"
            />
            <RatingBar
              label="Amenities"
              score={bokScoreBreakdown.amenities}
              icon="ðŸŽ¯"
            />
            <RatingBar
              label="Accessibility"
            ...
            <RatingBar
              label="Value"
              score={bokScoreBreakdown.value}
              icon="ðŸ’°"
            />
          </div>
          <div className="mt-4 pt-4 border-t border-gray-200 text-xs text-gray-500">
            <p>
              We evaluate shopping malls based on store variety, facilities quality, visitor comfort, and overall shopping experience. Our assessment combines expert evaluations, shopper feedback, and firsthand inspections.
            </p>
            <p className="mt-2 italic">
              Scores above 9.00 denote world-class quality, signifying Goa&apos;s premier shopping destinations.
            </p>
          </div>
        </details>
      )}
