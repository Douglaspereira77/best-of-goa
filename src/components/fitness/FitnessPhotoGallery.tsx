...
interface FitnessPhotoGalleryProps {
  images: FitnessImage[];
  fitnessPlaceName: string;
}

export function FitnessPhotoGallery({ images, fitnessPlaceName }: FitnessPhotoGalleryProps) {
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
        {sortedImages.slice(0, 6).map((image, index) => (
          ...
          >
            <Image
              src={image.url}
              alt={image.alt_text || `${fitnessPlaceName} photo ${index + 1}`}
              fill
            ...
            <div className="relative w-full h-full flex items-center justify-center">
              ...
              <div className="relative w-full h-full p-16">
                <Image
                  ...
                  alt={currentImage.alt_text || `${fitnessPlaceName} photo ${selectedIndex + 1}`}
                  fill
