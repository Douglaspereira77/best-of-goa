...
interface AttractionGovernorateCardProps {
  governorate: Governorate;
}

export function AttractionGovernorateCard({ governorate }: AttractionGovernorateCardProps) {
  return (
    <Link href={`/places-to-visit?governorate=${governorate.slug}`}>
