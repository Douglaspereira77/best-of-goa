-- Migration: Fix ALL hotel related tables (FAQs, Rooms, Policies) - V3 FIXED
-- Created: 2025-11-14
...
-- HOTEL_ROOMS TABLE
-- ========================================
-- Add hotel_room_type_id column (INTEGER to match hotel_room_types.id)
ALTER TABLE hotel_rooms ADD COLUMN IF NOT EXISTS hotel_room_type_id INTEGER REFERENCES hotel_room_types(id);
