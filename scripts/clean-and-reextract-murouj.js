...
async function cleanAndReextractMurouj() {
  console.log('🧹 CLEAN & RE-EXTRACT: Murouj Food Complex')
  ...
  try {
    ...
    console.log('')
    console.log('═'.repeat(80))
    console.log('✅ SUCCESS! Murouj images re-extracted with Vision AI')
    console.log('═'.repeat(80))
    console.log('')
    console.log('📝 Next: Check the database to verify AI metadata')
    console.log('   Run: node scripts/show-murouj-metadata.js')
...
cleanAndReextractMurouj().catch(console.error)
